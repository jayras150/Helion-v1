...
export function ProjectCard({ project, selected = false, onSelect }: ProjectCardProps) {
  ...
  return (
    <div className={`group relative overflow-hidden rounded-2xl border bg-white/92 shadow-[0_12px_35px_-24px_rgba(79,70,229,0.7)] backdrop-blur-xl transition-all hover:-translate-y-1 hover:shadow-xl dark:bg-slate-950/90 ${selected ? "border-cyan-500 ring-2 ring-cyan-500/20" : "border-white/60 dark:border-white/[0.06]"}`}>
      {onSelect ? (
